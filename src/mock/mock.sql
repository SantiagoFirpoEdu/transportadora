...
INSERT INTO PESSOAS_FISICAS (ID_CLIENTE, CPF)
VALUES (1, 12345678900);
INSERT INTO PESSOAS_FISICAS (ID_CLIENTE, CPF)
VALUES (2, 98765432100);

INSERT INTO PESSOAS_JURIDICAS (ID_CLIENTE, CNPJ, INSCRICAO_ESTADUAL)
VALUES (3, 123456, 1234);
INSERT INTO PESSOAS_JURIDICAS (ID_CLIENTE, CNPJ, INSCRICAO_ESTADUAL)
VALUES (4, 987654, 9876);

INSERT INTO ENTREGAS (ID_ENTREGA, ID_CLIENTE, DATA_SAIDA, DATA_CHEGADA, VALOR)
VALUES (1, 1, TO_DATE('01/05/2022', 'dd/mm/yyyy'), TO_DATE('02/06/2022', 'dd/mm/yyyy'), 100.00);
INSERT INTO ENTREGAS (ID_ENTREGA, ID_CLIENTE, DATA_SAIDA, DATA_CHEGADA, VALOR)
VALUES (2, 2, TO_DATE('02/03/2022', 'dd/mm/yyyy'), TO_DATE('12/04/2022', 'dd/mm/yyyy'), 200.00);
INSERT INTO ENTREGAS (ID_ENTREGA, ID_CLIENTE, DATA_SAIDA, DATA_CHEGADA, VALOR)
VALUES (3, 3, TO_DATE('01/05/2022', 'dd/mm/yyyy'), TO_DATE('04/06/2022', 'dd/mm/yyyy'), 300.00);
...
VALUES (1, 1, 3, 1, 100000.00, 1000.00);
INSERT INTO APOLICES(ID_APOLICE, NUMERO_SEGURADORA, ID_CLIENTE, ID_ENTREGA, VALOR_PREMIO, VALOR_FRANQUIA)
VALUES (2, 2, 4, 2, 100000.00, 1000.00);
INSERT INTO APOLICES(ID_APOLICE, NUMERO_SEGURADORA, ID_CLIENTE, ID_ENTREGA, VALOR_PREMIO, VALOR_FRANQUIA)
VALUES (3, 1, 3, 3, 1000000.00, 1000.00);
INSERT INTO APOLICES(ID_APOLICE, NUMERO_SEGURADORA, ID_CLIENTE, ID_ENTREGA, VALOR_PREMIO, VALOR_FRANQUIA)
VALUES (4, 2, 4, 4, 1000.00, 1000.00);
INSERT INTO APOLICES(ID_APOLICE, NUMERO_SEGURADORA, ID_CLIENTE, ID_ENTREGA, VALOR_PREMIO, VALOR_FRANQUIA)
VALUES (5, 1, 3, 5, 1000.00, 1000.00);
INSERT INTO APOLICES(ID_APOLICE, NUMERO_SEGURADORA, ID_CLIENTE, ID_ENTREGA, VALOR_PREMIO, VALOR_FRANQUIA)
VALUES (6, 2, 4, 6, 100000.00, 1000.00);

INSERT INTO CATEGORIAS_ITEM(ID_CATEGORIA, DESCRICAO)
VALUES (1, 'Maquinário');
INSERT INTO CATEGORIAS_ITEM(ID_CATEGORIA, DESCRICAO)
VALUES (2, 'Logística');
INSERT INTO CATEGORIAS_ITEM(ID_CATEGORIA, DESCRICAO)
...
VALUES (1, 12345678, 'Rua dos Alcântaras', 1030, 'Vila Madalena', 'São Paulo', 'SP', 1);
INSERT INTO ENDERECOS(ID_ENDERECO, CEP, RUA, NUMERO, BAIRRO, CIDADE, UNIDADE_FEDERATIVA, ID_CLIENTE)
...
VALUES (3, 12345678, 'Rua Doutor Henrique', 302, 340, 'Vila Mariana', 'São Paulo', 'SP', 3);
INSERT INTO ENDERECOS(ID_ENDERECO, CEP, RUA, NUMERO, COMPLEMENTO, BAIRRO, CIDADE, UNIDADE_FEDERATIVA, ID_CLIENTE)
